...
# os.environ["SUMO_HOME"] = r"C:\Users\41775\Desktop\sumo-git"

os.environ["SUMO_HOME"] = "/home/amaris/Downloads/sumo-1.7.0"
...
def main():
    ...
    simulation = Simulation(simulation_steps, sleep_time, pedestrians, bus_depot_start_edge, bus_depot_end_edge, \
                            args.capacity, args.interval, args.stopDuration, args.departPref)
    simulation.algo()
    # simulation.run()
...
def set_configurations():
    parser = argparse.ArgumentParser(description='ELCA Challenge')
    parser.add_argument('--capacity', type=int, default=4, help='Capacity of bus vehicle')
    parser.add_argument('--interval', type=int, default=15, help='Time interval of bus dispatch (in mins)')
    parser.add_argument('--seed', type=int, default=30, help='Pedestrian Seed')
    parser.add_argument('--steps', type=int, default=86400, help='Simulation Steps in seconds')
    # parser.add_argument('--steps', type=int, default=3600, help='Simulation Steps in seconds')
    parser.add_argument('--stopDuration', type=int, default=5, help='Stop Duration')
    parser.add_argument('--departPref', type=str, default='min', help='Depart Preference')
...
class Person:
    ...
    def short_debug_string(self):
        print('id:', self.id, "edge_from:", self.edge_from, 'edge_to:', self.edge_to)
        print("position_from:", self.position_from, 'position_to:', self.position_to, 'depart:', self.depart)
